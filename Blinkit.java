class Blinkit {
	public static double search(String foodName) {
		...
		if (foodName == "AlooBhujia") {
			price = 200;
			return price;
		}
		if (foodName == "AlooTikki") {
			price = 200;
			return price;
		}
		if (foodName == "Noodles") {
		...
		if (foodName == "Dry pulao") {
			price1 = 100 * quantity;
			return price1;
		}
		if (foodName == "pakal pulao") {
			price1 = 100 * quantity;
			return price1;
		}
		if (foodName == "tomato pulao") {
			price1 = 100 * quantity;
			return price1;
		}
